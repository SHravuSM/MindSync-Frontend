...
const Tabs = () => {
  ...
  return (
    <div
      className={`relative flex w-[85%] max-w-md mx-auto overflow-hidden ${
    ...
    >
      ...
      <motion.div
        ...
        className={`absolute top-1 bottom-1 left-1 w-20 rounded-sm shadow-md ${
          dark
