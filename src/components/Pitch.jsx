        ...
        return (
          <div className="space-y-4 sm:space-y-6">
            {/* <div>
              ...
              >
                <div
                  className={`w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 rounded-sm flex items-center justify-center ${
                    ...
                    {formData.media.map((file, index) => (
                      ...
                      >
                        <div className="flex items-center gap-2 sm:gap-3">
                          <div
                            className={`w-6 h-6 sm:w-8 sm:h-8 rounded flex items-center justify-center ${
                              file.type === "pdf"
                          ...
                          <div>
                            <div className="text-xs sm:text-sm font-medium truncate max-w-[150px] sm:max-w-xs">
                              {file.url}
                            </div>
