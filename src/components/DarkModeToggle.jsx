...
export default function DarkModeToggle() {
  ...
  return (
    <motion.button
      onClick={() => setDark()}
      className={`lg:w-8 w-7 cursor-pointer h-7 lg:h-8 rounded-full flex items-center justify-center focus:outline-none focus-visible:ring-2 border transition-all duration-300 ${
        dark
