...
// const InProfileCard = () => {
//     const { logout, state, setState, dark, setDark } = useAuthStore();

//     return (
//         // <div className="absolute bottom-16 right-6 lg:right-2/7 z-10">
//         <div className="fixed bottom-16 right-6 lg:right-[30.57%] z-10">

//             {state && <div className="flex flex-col w-52 bg-gray-900 justify-center rounded-lg transition-all duration-1000 p-2.5 overflow-hidden group">
//                 <Link to='profile' className="text-sm bg-transparent border-none p-2.5 text-white flex relative gap-1.5 cursor-pointer rounded-lg transition-all duration-500 box-border hover:border-2 hover:border-gray-800 hover:text-white focus:bg-gray-800 focus:outline-none focus:ml-4 active:bg-gray-800 active:ml-4 before:content-[''] before:absolute before:top-1 before:-left-4 before:w-1.5 before:h-4/5 before:bg-blue-500 before:rounded-md before:opacity-0 before:transition-all before:duration-500 focus:before:opacity-100 active:before:opacity-100 group-hover:[&:not(:hover)]:blur-sm group-hover:[&:not(:hover)]:scale-95 group-hover:[&:not(:hover)]:transition-all group-hover:[&:not(:hover)]:duration-300">
//                     <svg data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className="w-5">
...
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="Line" className="w-5">
...
//                 <button className="text-sm bg-transparent border-none p-2.5 text-white flex relative gap-1.5 cursor-pointer rounded-lg transition-all duration-500 box-border hover:border-2 hover:border-gray-800 hover:text-white focus:bg-gray-800 focus:outline-none focus:ml-4 active:bg-gray-800 active:ml-4 before:content-[''] before:absolute before:top-1 before:-left-4 before:w-1.5 before:h-4/5 before:bg-blue-500 before:rounded-md before:opacity-0 before:transition-all before:duration-500 focus:before:opacity-100 active:before:opacity-100 group-hover:[&:not(:hover)]:blur-sm group-hover:[&:not(:hover)]:scale-95 group-hover:[&:not(:hover)]:transition-all group-hover:[&:not(:hover)]:duration-300">
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="w-5">
...
//                 <button className="text-sm bg-transparent border-none p-2.5 text-white flex relative gap-1.5 cursor-pointer rounded-lg transition-all duration-500 box-border hover:border-2 hover:border-gray-800 hover:text-white focus:bg-gray-800 focus:outline-none focus:ml-4 active:bg-gray-800 active:ml-4 before:content-[''] before:absolute before:top-1 before:-left-4 before:w-1.5 before:h-4/5 before:bg-blue-500 before:rounded-md before:opacity-0 before:transition-all before:duration-500 focus:before:opacity-100 active:before:opacity-100 group-hover:[&:not(:hover)]:blur-sm group-hover:[&:not(:hover)]:scale-95 group-hover:[&:not(:hover)]:transition-all group-hover:[&:not(:hover)]:duration-300">
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="svg8" className="w-5">
...
//                 <button className="text-sm bg-transparent border-none p-2.5 text-white flex relative gap-1.5 cursor-pointer rounded-lg transition-all duration-500 box-border hover:border-2 hover:border-gray-800 hover:text-white focus:bg-gray-800 focus:outline-none focus:ml-4 active:bg-gray-800 active:ml-4 before:content-[''] before:absolute before:top-1 before:-left-4 before:w-1.5 before:h-4/5 before:bg-blue-500 before:rounded-md before:opacity-0 before:transition-all before:duration-500 focus:before:opacity-100 active:before:opacity-100 group-hover:[&:not(:hover)]:blur-sm group-hover:[&:not(:hover)]:scale-95 group-hover:[&:not(:hover)]:transition-all group-hover:[&:not(:hover)]:duration-300">
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" fill="none" className="w-5">
...
const InProfileCard = () => {
    ...
    const menuItemClasses =
        "text-sm bg-transparent border-none p-2.5 text-white flex relative gap-1.5 cursor-pointer rounded-lg transition-all duration-500 box-border hover:border-2 hover:border-gray-800 focus:bg-gray-800 focus:outline-none focus:ml-4 active:bg-gray-800 active:ml-4 before:content-[''] before:absolute before:top-1 before:-left-4 before:w-1.5 before:h-4/5 before:bg-blue-500 before:rounded-md before:opacity-0 before:transition-all before:duration-500 focus:before:opacity-100 active:before:opacity-100 group-hover:[&:not(:hover)]:blur-sm group-hover:[&:not(:hover)]:scale-95 group-hover:[&:not(:hover)]:transition-all group-hover:[&:not(:hover)]:duration-300";

    return (
        <div className="fixed bottom-16 right-6 lg:right-[30.57%] z-10">
            {state && (
                <div className="flex flex-col w-52 bg-gray-900 justify-center rounded-lg transition-all duration-1000 p-2.5 overflow-hidden group">
                    {/* Public Profile */}
                    ...
                    <button className={menuItemClasses}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5">
                            ...
                            <path
                                fill="#7D8590"
                                d="m17.074 30h-2.148c-1.038 0-1.914-.811-1.994-1.846l-.125-1.635a12.941 12.941 0 0 1-3.964-1.751l-1.246 1.067a1.999 1.999 0 0 1-2.715-.104l-1.52-1.52a2 2 0 0 1-.104-2.715l1.067-1.246a12.94 12.94 0 0 1-1.751-3.964l-1.634-.125a2 2 0 0 1-1.846-1.993v-2.148a2 2 0 0 1 1.846-1.994l1.635-.125a12.94 12.94 0 0 1 1.751-3.964l-1.068-1.247a2 2 0 0 1 .104-2.715l1.52-1.52a2 2 0 0 1 2.715-.104l1.246 1.067a12.94 12.94 0 0 1 3.964-1.751l.125-1.634a2 2 0 0 1 1.994-1.845h2.148a2 2 0 0 1 1.994 1.846l.125 1.635a12.94 12.94 0 0 1 3.964 1.751l1.246-1.067a2 2 0 0 1 2.715.104l1.52 1.52a2 2 0 0 1 .104 2.715l-1.067 1.246a12.94 12.94 0 0 1 1.751 3.964l1.634.125a2 2 0 0 1 1.846 1.993v2.148a2 2 0 0 1-1.846 1.994l-1.635.125a12.94 12.94 0 0 1-1.751 3.964l1.067 1.246a2 2 0 0 1-.104 2.715l-1.52 1.52a2 2 0 0 1-2.715.104l-1.246-1.067a12.941 12.941 0 0 1-3.964 1.751l-.125 1.634a2 2 0 0 1-1.993 1.846z"
                            />
                        </svg>
                        Account
                    </button>
                    ...
                    <button className={menuItemClasses}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="w-5">
                            <path
                                fill="#7D8590"
                                d="M109.9 20.63a6.232 6.232 0 0 0-8.588-.22l-57.463 51.843-4.721 4.722a1.749 1.749 0 0 0 0 2.475l.341.342-3.16 3.16a8 8 0 0 0-1.424 1.967 11.382 11.382 0 0 0-12.055 10.609 5.763 5.763 0 0 1-4.928 5.41 1.75 1.75 0 0 0-.844 3.14c4.844 3.619 9.4 4.915 13.338 4.915a17.14 17.14 0 0 0 11.738-4.545l.182-.167a11.354 11.354 0 0 0 3.348-8.081c0-.225-.02-.445-.032-.667a8.041 8.041 0 0 0 1.962-1.421l3.16-3.161.342.342a1.749 1.749 0 0 0 2.475 0l4.722-4.722 51.844-57.46a6.236 6.236 0 0 0-.219-8.589z"
                            />
                        </svg>
                        Appearance
                    </button>
                    ...
                    <button className={menuItemClasses}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5">
                            <path fill="#7D8590" d="M...AccessibilityIconPath..." />
                        </svg>
                        Accessibility
                    </button>
                    ...
                    {/* Notifications */}
                    <button className={menuItemClasses}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" className="w-5">
                            <path
                                fill="#7D8590"
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M11.9572 4.31201c-3.35401 0-6.00906 2.59741-6.00906 5.67742v3.29037c0 .1986-.05916.3927-.16992.5576l-1.62529 2.4193..."
                            />
                        </svg>
                        Notifications
                    </button>
                    ...
                    {/* Logout */}
                    <button onClick={logout} className={menuItemClasses}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
